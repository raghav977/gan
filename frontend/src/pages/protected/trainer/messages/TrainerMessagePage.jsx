...
import { MdVideoCall, MdCall, MdSend, MdSearch } from "react-icons/md";
...
export default function TrainerMessagePage() {
                                ...
                                >
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="flex items-center justify-between">
                                            <div className="font-medium truncate">{other?.username || "User"}</div>
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <div className="font-semibold">
                                        {selected.otherParticipant?.username || "User"}
                                    </div>
                                    <div className="text-xs text-gray-400">
                                        {isOnline(selected.otherParticipant?.id)
                                            ? "Online"
