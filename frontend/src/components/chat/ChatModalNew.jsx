...
function ChatModal({ trainer, onClose }) {
    ...
    useEffect(() => {
        const initConversation = async () => {
            if (!isAuthenticated || !trainer?.userId) return;
    ...
    return (
        <>
            <div className="fixed bottom-4 right-4 z-50 w-96 h-[500px] bg-white rounded-xl shadow-2xl flex flex-col overflow-hidden border">
                {/* Header */}
                <div className="flex items-center justify-between p-4 bg-gradient-to-r from-yellow-500 to-yellow-600 text-white">
                ...
                <form onSubmit={handleSendMessage} className="p-4 bg-white border-t">
                    <div className="flex items-center gap-2">
                        ...
                        <button
                            type="submit"
                            disabled={!inputText.trim() || sending || !conversation}
